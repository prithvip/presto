...
import static com.facebook.presto.thrift.api.datatypes.PrestoThriftBlock.integerArrayData;
 ...
 */
@ThriftStruct
public final class PrestoThriftIntegerArray
        implements PrestoThriftColumnData
{
    private final boolean[] nulls;
    private final int[] sizes;
    private final PrestoThriftInteger values;

    @ThriftConstructor
    public PrestoThriftIntegerArray(
            @ThriftField(name = "nulls") @Nullable boolean[] nulls,
            @ThriftField(name = "sizes") @Nullable int[] sizes,
            @ThriftField(name = "values") @Nullable PrestoThriftInteger values)
    {
    ...
    public PrestoThriftInteger getValues()
    {
        return values;
    }
    ...
    {
        checkArgument(desiredType.getTypeParameters().size() == 1 && INTEGER.equals(desiredType.getTypeParameters().get(0)),
        ...
        return ArrayBlock.fromElementBlock(
                ...
                values != null ? values.toBlock(INTEGER) : new IntArrayBlock(0, Optional.empty(), new int[] {}));
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        PrestoThriftIntegerArray other = (PrestoThriftIntegerArray) obj;
    ...
    public static PrestoThriftBlock fromBlock(Block block)
    {
        ...
        if (positions == 0) {
            return integerArrayData(new PrestoThriftIntegerArray(null, null, null));
        }
        boolean[] nulls = null;
        int[] sizes = null;
        ...
        PrestoThriftInteger values = arrayBlock
                .apply((valuesBlock, startPosition, length) -> PrestoThriftInteger.fromBlock(valuesBlock), 0)
                .getIntegerData();
        ...
        return integerArrayData(new PrestoThriftIntegerArray(nulls, sizes, values));
    }

    private static int numberOfValues(PrestoThriftInteger values)
    {
